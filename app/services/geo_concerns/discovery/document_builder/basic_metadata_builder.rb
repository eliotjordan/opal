...
# Remove once merged: https://github.com/projecthydra-labs/geo_concerns/pull/253
module GeoConcerns
  module Discovery
    class DocumentBuilder
      class BasicMetadataBuilder
        ...
        private
          ...
          def identifier
            indentifiers = geo_concern.solr_document[:identifier_tesim]
            indentifiers ? indentifiers.first : geo_concern.id
          end
